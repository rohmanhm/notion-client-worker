...
export class NotionAPI {
  ...
  public async getPage(
    ...
    const page = await this.getPageRaw(pageId, kyOptions)
  ...
  public async getPageRaw(pageId: string, kyOptions?: Options) {
  ...
  public async getUsers(userIds: string[], kyOptions?: Options) {
  ...
  public async getBlocks(blockIds: string[], kyOptions?: Options) {
    return this.fetch<notion.PageChunk>({
  ...
  public async search(params: notion.SearchParams, kyOptions?: Options) {
